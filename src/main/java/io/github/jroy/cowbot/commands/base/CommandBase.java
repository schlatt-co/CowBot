...
public abstract class CommandBase extends Command {
  ...
  protected final void execute(com.jagrosh.jdautilities.command.CommandEvent event) {
    ...
    executeCommand(new io.github.jroy.cowbot.commands.base.CommandEvent(event.getEvent(), event.getArgs(), event.getClient()));
  }
   ...
   */
  protected abstract void executeCommand(io.github.jroy.cowbot.commands.base.CommandEvent event);
}